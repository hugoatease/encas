    ...
    function(ko, api, common) {
        var module = {
            ...
            showAccountData: function (account_id) {
                common.current.account_id = account_id;
                ...
                function refreshAccount(data) {
                    ...
                    this.date(common.formatDate(date));
                ...
                api.account.get(refreshAccount.bind(this), common.current.account_id);
                api.account.balance(refreshBalance.bind(this), common.current.account_id, true);
            },
            ...
            edit : function(target) {
                ...
                if (this.edited.staff() !== this.staff()) {
                    api.account.staff(staff_success.bind(this), common.current.account_id, this.edited.staff());
                }

                api.account.edit(refresh.bind(this), common.current.account_id, this.edited.firstname(), this.edited.lastname(), this.edited.promo());
            },
            ...
            delete : function(target) {
                ...
                api.account.delete(refresh.bind(this), common.current.account_id);
            }
        };
